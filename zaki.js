...
//FAKE QUOTED
const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@g.us"},"message": {"groupInviteMessage": {"groupJid": "6287772549185-1622678501@g.us","inviteCode": "https://chat.whatsapp.com/CCyaeuaLuUbAmWCvQvFJLm","groupName": "Group Official", "caption": `${footer}`, 'jpegThumbnail': ('./media/zaki.jpg')}}}
        ...
        if (stderr.trim()) reply(stderr)
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	zaki.sendMessage(`201507384088@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
reply(`Successfully Reported To The Owner\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    }
                    break 
case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'gaara': case 'doge':{
                anu = `Hi ${pushname} 🤚`
...
var butonnya =
[{ urlButton: { displayText: 'Group Official', url: 'https://chat.whatsapp.com/CCyaeuaLuUbAmWCvQvFJLm'} }, 
...
break
case 'ssweb': {
if (!args[0]) return reply(`Example : \n${prefix + command} https://instagram.com/gaara_xploite`)
